...
export DEFCONFIG="vendor/munch_defconfig";
export ZIP_DIR="${KERNELDIR}/files";
export IMAGE="${OUTDIR}/arch/${ARCH}/boot/Image";
export DTB="${OUTDIR}/arch/${ARCH}/boot/dtb";
...
then
  NO_MENUCONFIG=1
  MAKE_STATEMENT="$MAKE_STATEMENT KCONFIG_CONFIG=./arch/arm64/configs/vendor/munch_defconfig"
fi
